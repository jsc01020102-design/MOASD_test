  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-20 pointer-events-none select-none border border-white/5 m-5 md:m-8 rounded-2xl overflow-hidden">
        ...
        {videoUrl && (
          <div className="absolute bottom-4 right-4 text-[6px] text-white/40 bg-slate-950/40 backdrop-blur-[2px] px-1.5 py-0.5 rounded-md border border-white/5 font-sans tracking-wide">
