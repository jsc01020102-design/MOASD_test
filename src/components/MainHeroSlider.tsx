  ...
  return (
    ...
    >
              ...
              {getYoutubeId(videoUrl) ? (
                <div className="relative w-full h-full select-none pointer-events-none">
                  ...
                  <iframe
                    ...
                    allowFullScreen
                    className="absolute top-1/2 left-1/2 w-[177.77777778vh] min-w-full h-[56.25vw] min-h-full -translate-x-1/2 -translate-y-1/2 scale-110 z-10 pointer-events-none"
      ...
      <div className="absolute inset-0 z-20 pointer-events-none select-none border border-white/5 m-5 md:m-8 rounded-2xl overflow-hidden">
        ...
        {videoUrl && (
          <div className="absolute bottom-4 right-4 flex flex-col items-end gap-1 font-mono tracking-wide z-20 pointer-events-auto">
            <div className="px-2 py-0.5 text-[8px] font-black uppercase text-cyan-400 bg-slate-950/85 backdrop-blur-md rounded-md border border-cyan-400/30 flex items-center gap-1">
              <span className="w-1.5 h-1.5 bg-cyan-400 rounded-full animate-pulse"></span>
              <span>8K DSLR HYPER-REALISTIC VIDEO STREAM ACTIVE</span>
            </div>
            <div className="text-[6px] text-white/40 bg-slate-950/40 backdrop-blur-[2px] px-1.5 py-0.5 rounded-md border border-white/5 self-end">
              {t('hero.ai_video_disclaimer', 'This video was generated by AI.', '본 영상은 AI로 제작 되었습니다.')}
            </div>
          </div>
        )}
      </div>
